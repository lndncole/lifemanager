...
async function startChat(conversation) {
  ...
  let conversationObject = {
    ...
    messages: [
      ...
      { role: 'user', content: `If I ask you to make a search or to look for information, then you should perform a "google-search" by calling the "google-search" function and adding a query that can be used to address my needs. Make sure to ask for my permission before doing any Google searches. If I ask you to do a search that requires knowing my location to give the best results, ask e for my location.
